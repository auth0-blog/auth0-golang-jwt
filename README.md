...
1. Update the `.env` file with your Auth0 Credentials. [Sign up](https://auth0.com) for an account for free if you don't have one.
2. Update the `auth0-variables.js` file in `static/js` with your Auth0 Credentials.
3. Add `localhost:3000` to your Allowed Callback URL's in your [Auth0 Management Dashboard](https://manage.auth0.com).
